        ...
        <section className="flex flex-col w-full">
          ...
          <div className="flex w-full justify-between gap-2 ">
            <div ref={animationParent} className="space-x-2 text-[0.8rem]">
              <span className="md:text-sm whitespace-nowrap text-Very-Dark-Blue hover:text-Blue font-extrabold cursor-pointer">{user}</span>
              ...
              {action === "reacted to your recent post" && (
                ...
                {
                  group === "Chess Club" && (
                    <span className="font-extrabold text-Blue cursor-pointer">{group}</span>
                  )
                }
              {/* red notification */}
              {read === false && (
